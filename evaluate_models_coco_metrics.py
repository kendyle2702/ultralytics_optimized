...
class VisDroneEvaluator:
    ...
    def measure_fps(self, model, num_warmup=10, num_iterations=100):
        ...
        return {"fps": fps, "latency_ms": latency_ms, "device": "GPU" if torch.cuda.is_available() else "CPU"}

    def run_inference(self, model_path, model_name):
        """Run inference with YOLO model and convert to COCO format. Also measures parameters and FPS.
        ...
        # Combine model info
        model_info = {**param_info, **fps_info}
