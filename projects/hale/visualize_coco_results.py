...
class ResultsVisualizer:
    ...
    def plot_efficiency_scatter(self, df):
        ...
        ax.set_title('Efficiency Analysis: FPS vs AP (bubble size = parameters)', 
        ...
        legend_elements = [plt.scatter([], [], s=s*50, alpha=0.6, c='gray') 
                          for s in sizes]
        ax.legend(legend_elements, labels, title='Parameters', 
