...
def main():
    ...
    print(f"  + SAHI mAP50:   {coco_sahi['metrics']['mAP50']:.4f} ({calculate_improvement(coco_sahi['metrics']['mAP50'], coco_base['metrics']['mAP50']):+.0f}%)")
    
    print(f"\nVisDrone Models:")
    print(f"  Baseline mAP50: {vd_base['metrics']['mAP50']:.4f}")
    print(f"  + SAHI mAP50:   {vd_sahi['metrics']['mAP50']:.4f} ({calculate_improvement(vd_sahi['metrics']['mAP50'], vd_base['metrics']['mAP50']):+.0f}%)")
